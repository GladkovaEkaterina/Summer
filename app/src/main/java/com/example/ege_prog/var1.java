...
public class var1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView9.setImageResource(R.drawable.im9);
        ...
        imageView10.setImageResource(R.drawable.im10);
        ...
        imageView11.setImageResource(R.drawable.im11);
        ...
        imageView12.setImageResource(R.drawable.im12);
